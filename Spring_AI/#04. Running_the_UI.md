...
![Features](images/spring_ai_features.png)
...
![Spring_AI_UI](images/spring_ai_ui.jpeg)
...
![Spring_AI_Error](spring_ai_error.jpeg)
...
- **Ollama Models**: Mistral, Llama, DeepSeek, etc.

### 2. Simple Interface

- **Text Input Field**: Enter your prompt or question
- **Submit Button**: Trigger requests to all configured models
- **Response Display**: View results side-by-side for easy comparison

### 3. Real-Time Results

Responses are displayed as they arrive from each model, allowing immediate comparison of:
- Response quality
- Response speed
- Answer accuracy
- Writing style
