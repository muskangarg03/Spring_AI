# Setting Up Spring Boot with Spring AI Project

This guide covers the complete setup process for creating a **Spring Boot application integrated with Spring AI** framework. The project enables seamless integration with multiple AI model providers including OpenAI, Anthropic (Claude), and Ollama (local models), allowing developers to leverage AI capabilities within their Spring applications.
